...
interface AllMerchantsListProps {
...
export default function AllMerchantsList({
  statsWindow,
  onCategoryUpdate,
  allCategories,
  searchQuery,
}: AllMerchantsListProps) {
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-body font-semibold text-[var(--color-text-primary)]">
          Merchants ({filteredMerchants.length}{searchQuery && ` of ${merchants.length}`})
        </h3>
      </div>
