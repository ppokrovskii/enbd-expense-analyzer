...
def test_user_id_indexes_created(test_db):
    ...
    # The unique constraint includes workspace_id for multi-workspace support
    assert 'idx_categories_user_workspace_name' in index_names or 'ix_categories_workspace_id' in index_names
